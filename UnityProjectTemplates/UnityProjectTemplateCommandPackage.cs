...
namespace UnityProjectTemplates
{
    ...
    [Guid(UnityProjectTemplateCommandPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class UnityProjectTemplateCommandPackage : AsyncPackage
    {
        /// <summary>
        /// AddMonoBehaviourCommandPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "59e25f6f-99d2-4be2-bf04-8ec839c7665a";
